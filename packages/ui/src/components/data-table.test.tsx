...
const DATA: Person[] = [
  { id: 1, name: "Charlie", email: "charlie@cronus.com", amount: 30 },
  { id: 2, name: "Alice", email: "alice@cronus.com", amount: 10 },
  { id: 3, name: "Bob", email: "bob@cronus.com", amount: 20 },
];
...
describe("DataTable — rendering", () => {
  ...
  it("renders one body row per record", () => {
    ...
    expect(screen.getByRole("cell", { name: "alice@cronus.com" })).toBeInTheDocument();
  });
...
describe("DataTable — helpers", () => {
  it("fuzzyTextFilter matches case-insensitively", () => {
    const row = { getValue: () => "Cronus Checkout" } as never;
