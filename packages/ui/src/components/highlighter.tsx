...
export function Highlighter({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-x-0 bottom-[0.08em] -z-10 h-[0.45em] origin-bottom-start rounded-sm bg-primary/25 [animation-duration:var(--highlight-duration)] [animation-fill-mode:both] [animation-name:cronus-highlighter] [animation-timing-function:cubic-bezier(.22,1,.36,1)] motion-reduce:[animation-name:none]"
      />
      {children}
    </span>
  );
