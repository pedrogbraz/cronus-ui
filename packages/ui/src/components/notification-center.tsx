  ...
  ({ className, notification, onSelect, ...props }, ref) => {
    ...
    return (
      <button
        ...
        onClick={() => onSelect?.(id)}
        className={cn(
          "flex w-full items-start gap-3 rounded-md px-2 py-2.5 text-start outline-none transition-colors hover:bg-surface-overlay focus-visible:bg-surface-overlay focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset",
