...
import type { ArcDatum, Focus } from "./sunburst.js";
import { useSunburstHover, useSunburstStable } from "./sunburst-context.js";
...
export const SunburstHint = memo(function SunburstHint({ className, children }: SunburstHintProps) {
