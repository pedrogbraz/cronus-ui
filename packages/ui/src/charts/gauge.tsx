...
import { type ChartStatFlowFormat, defaultChartStatFlowFormat } from "./chart-stat-flow.js";
import {
...
import {
  ...
  resolveGaugeBgFill,
} from "./notch-gauge-shared.js";
import { PieCenterShell } from "./pie-center-shell.js";
...
export function Gauge({
  ...
  if (isLinear) {
    ...
    return (
      <div className={cn("relative w-full min-w-0 max-w-full", className)} data-slot="gauge-chart">
  ...
  if (widthProp != null && heightProp != null) {
    return (
      <div className={cn("relative inline-flex max-w-full", className)} data-slot="gauge-chart">
