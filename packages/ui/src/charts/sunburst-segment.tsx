...
import { applyHoverGrow, arcPath, transitionGeometry } from "./sunburst.js";
import { sunburstCssVars, useSunburstHover, useSunburstStable } from "./sunburst-context.js";
...
export const SunburstSegment = memo(function SunburstSegment({
  ...
  const segmentDelay = (arc ? enterTiming.segmentDelays.get(arc.id)?.delay : undefined) ?? 0;
