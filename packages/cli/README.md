...
- The default registry is pinned to the CLI package version (`v0.6.9` here), not
...
```json
{
  ...
  "registry": "https://raw.githubusercontent.com/pedrogbraz/cronus-ui/v0.6.9/registry"
}
```
