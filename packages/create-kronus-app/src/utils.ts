...
export function outroLines(
  ...
  const grow = composed
    ? [
        ...
        `  ${dollar} npx kronus-ui add-page --route /pricing --blocks pricing,cta --nav Pricing`,
        `  ${dollar} npx kronus-ui theme set aurora --mode dark`,
        `  ${dollar} npx kronus-ui upgrade --all --dry-run`,
      ]
    : [
        `Add more components anytime:  ${dollar} npx kronus-ui add dialog table tabs`,
        `Want a multi-page app?        ${dollar} npx kronus-ui compose saas`,
      ];
  return [
    "",
    `${c.green(c.bold("Done!"))} Your Kronus UI app is ready in ${c.cyan(name)}.`,
    "",
    "Next steps:",
    `  ${dollar} cd ${name}`,
...
export const log = {
  intro(): void {
    process.stdout.write(`\n${c.magenta(c.bold("create-kronus-app"))}\n\n`);
  },
...
/**
 * The template names generated by the Kronus Compose app generator (no bundled
...
/** The five shipped theme presets (must match @kronus-ui/tokens `ThemeName`). */
