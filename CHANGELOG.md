...
- **Invite-aware login copy.** `/login?invitation=` (and a stored
  `cronus-invitation`) shows "Join the workspace" on the classic and split
  login blocks. Default welcome copy is unchanged.
...
- **Home nav is Items.** saas and admin sidebar labels for `/` match the live
  `ItemsPanel` heading, not Dashboard/Overview.
...
[Unreleased]: https://github.com/pedrogbraz/cronus-ui/compare/v0.6.17...HEAD
...
[0.6.15]: https://github.com/pedrogbraz/cronus-ui/compare/v0.6.14...v0.6.15
