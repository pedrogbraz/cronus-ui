...
export const EXAMPLE_SECTIONS: Record<string, ExampleSectionMeta[]> = {
  ...
  "globe-wireframe": [{ id: "wireframe", title: "Wireframe solid" }],
  "slide-up-text": [
  ...
  "words-preloader": [{ id: "words", title: "Product words" }],
  actions: [{ id: "default", title: "Message actions" }],
  artifact: [{ id: "default", title: "Generated artifact" }],
  branch: [{ id: "default", title: "Alternative generations" }],
  "chain-of-thought": [{ id: "default", title: "Reasoning trail" }],
  "ai-code-block": [{ id: "default", title: "Tool output" }],
  context: [{ id: "default", title: "Token usage" }],
  conversation: [{ id: "empty", title: "Empty state" }],
  "ai-image": [{ id: "default", title: "Generated image" }],
  "inline-citation": [{ id: "default", title: "Cited claim" }],
  loader: [{ id: "default", title: "Generating" }],
  message: [{ id: "pair", title: "User and assistant" }],
  "open-in-chat": [{ id: "default", title: "Open elsewhere" }],
  plan: [{ id: "default", title: "Plan card" }],
  "prompt-input": [{ id: "default", title: "Composer" }],
  queue: [{ id: "default", title: "Pending work" }],
  reasoning: [{ id: "default", title: "Thinking" }],
  response: [{ id: "default", title: "Assistant text" }],
  sources: [{ id: "default", title: "Used sources" }],
  suggestion: [{ id: "default", title: "Prompt chips" }],
  task: [{ id: "default", title: "Agent checklist" }],
  "text-shimmer": [{ id: "default", title: "Thinking placeholder" }],
  tool: [{ id: "default", title: "Completed tool" }],
  "web-preview": [{ id: "default", title: "Sandboxed preview" }],
};
