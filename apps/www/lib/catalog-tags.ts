...
const SLUG_OVERRIDES: Record<string, TagPatch> = {
  ...
  "goal-card": { style: "operational", intents: ["data", "dashboard"] },
  "todo-item": { style: "operational", intents: ["data", "dashboard"] },
  "author-tooltip": { intents: ["overlay"] },
  "component-preview-tooltip": { intents: ["overlay"] },
  "link-preview": { intents: ["overlay", "content"] },
  ...
  "usage-dashboard": { intents: ["billing", "dashboard", "data"] },
...
const VARIANT_OVERRIDES: Record<string, TagPatch> = {
  ...
  "stats::kpi-grid": { style: "operational", motion: "none" },
  ...
  "billing::subscription": { style: "default", motion: "none" },
  ...
  "user-management::empty": { style: "operational", motion: "none" },
  "kanban-board::empty": { style: "operational", motion: "none" },
  "audit-log::empty": { style: "operational", motion: "none" },
  "sessions::empty": { style: "operational", motion: "none" },
  ...
  "product-grid::empty": { style: "operational", motion: "none" },
