    ...
    <>
      ...
      {typeof window !== "undefined" &&
        createPortal(
                ...
                >
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      onClick={close}
                      className="absolute top-3 inset-inline-end-3 size-8 rounded-full bg-background border border-border shadow-lg flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
                    >
                      <X className="size-4" />
                    </motion.button>
                  </motion.div>
          ...
          document.querySelector("[data-template-stage]") ?? document.body,
        )}
    </>
  );
}
