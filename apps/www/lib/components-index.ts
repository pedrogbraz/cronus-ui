    ...
    items: [
      {
        slug: "chart",
        name: "Chart",
        description: "Low-level recharts primitive: ChartContainer, tooltip, cursor, legend.",
        importName:
          "ChartContainer, ChartTooltip, ChartTooltipContent, ChartCursor, ChartLegend, ChartLegendContent",
      },
      {
        slug: "area-chart",
        name: "AreaChart",
        description: "Time series with a filled region. Default and Motion variants.",
        importName: "AreaChart",
      },
      {
        slug: "line-chart",
        name: "LineChart",
        description: "Multi-series line. Default and Motion variants.",
        importName: "LineChart",
      },
      {
        slug: "live-line-chart",
        name: "LiveLineChart",
        description: "Streaming line. Default and Motion variants.",
        importName: "LiveLineChart",
      },
      {
        slug: "bar-chart",
        name: "BarChart",
        description: "Grouped or stacked columns. Default and Motion variants.",
        importName: "BarChart",
      },
      {
        slug: "composed-chart",
        name: "ComposedChart",
        description: "Area, bar, and line on one axis. Default and Motion variants.",
        importName: "ComposedChart",
      },
      {
        slug: "candlestick-chart",
        name: "CandlestickChart",
        description: "OHLC candles. Default and Motion variants.",
        importName: "CandlestickChart",
      },
      {
        slug: "funnel-chart",
        name: "FunnelChart",
        description: "Stage drop-off. Default and Motion variants.",
        importName: "FunnelChart",
      },
      {
        slug: "gauge-chart",
        name: "GaugeChart",
        description: "Radial score. Default and Motion variants.",
        importName: "GaugeChart",
      },
      {
        slug: "pie-chart",
        name: "PieChart",
        description: "Full pie. Default and Motion variants.",
        importName: "PieChart",
      },
      {
        slug: "ring-chart",
        name: "RingChart",
        description: "Donut with a hub total. Default and Motion variants.",
        importName: "RingChart",
      },
      {
        slug: "radar-chart",
        name: "RadarChart",
        description: "Polar comparison. Default and Motion variants.",
        importName: "RadarChart",
      },
      {
        slug: "scatter-chart",
        name: "ScatterChart",
        description: "Two-axis scatter. Default and Motion variants.",
        importName: "ScatterChart",
      },
      {
        slug: "sankey-chart",
        name: "SankeyChart",
        description: "Flow between nodes. Default and Motion variants.",
        importName: "SankeyChart",
      },
      {
        slug: "profit-loss-chart",
        name: "ProfitLossChart",
        description: "Series split at zero. Default and Motion variants.",
        importName: "ProfitLossChart",
      },
      {
        slug: "choropleth-chart",
        name: "ChoroplethChart",
        description: "Region intensity map. Default and Motion variants.",
        importName: "ChoroplethChart",
      },
      {
        slug: "sunburst-chart",
        name: "SunburstChart",
        description: "Hierarchical rings. Default and Motion variants.",
        importName: "SunburstChart",
      },
      {
        slug: "heatmap-chart",
        name: "HeatmapChart",
        description: "Calendar heatmap. Default and Motion variants.",
    ...
    items: [
      {
        slug: "actions",
        name: "Actions",
        description: "Icon actions for an assistant message — copy, retry, share.",
        importName: "Actions",
        rsc: true,
      },
      {
        slug: "artifact",
        name: "Artifact",
        description: "A framed canvas for generated files, code, or previews.",
        importName: "Artifact",
        rsc: true,
      },
      {
        slug: "branch",
        name: "Branch",
        description: "Step through alternative assistant generations.",
        importName: "Branch",
      },
      {
        slug: "chain-of-thought",
        name: "ChainOfThought",
        description: "A collapsible trail of model reasoning steps.",
        importName: "ChainOfThought",
      },
      {
        slug: "ai-code-block",
        name: "AiCodeBlock",
        description: "Compound code surface for tool output and streamed files.",
        importName: "AiCodeBlock",
      },
      {
        slug: "context",
        name: "Context",
        description: "Hover card for language-model token usage.",
        importName: "Context",
      },
      {
        slug: "conversation",
        name: "Conversation",
        description: "Auto-scrolling chat log with an empty state and jump-to-latest.",
        importName: "Conversation",
      },
      {
        slug: "ai-image",
        name: "GeneratedImage",
        description: "Renders a model-generated image from base64.",
        importName: "GeneratedImage",
        rsc: true,
      },
      {
        slug: "inline-citation",
        name: "InlineCitation",
        description: "Inline source badge with a hover card of citations.",
        importName: "InlineCitation",
      },
      {
        slug: "loader",
        name: "Loader",
        description: "Spinning glyph for in-flight generation.",
        importName: "Loader",
      },
      {
        slug: "message",
        name: "Message",
        description: "User and assistant bubbles with optional avatars.",
        importName: "Message",
        rsc: true,
      },
      {
        slug: "open-in-chat",
        name: "OpenIn",
        description: "Open a prompt in ChatGPT, Claude, Cursor, and other chats.",
        importName: "OpenIn",
      },
      {
        slug: "plan",
        name: "Plan",
        description: "Collapsible plan card the model can stream into.",
        importName: "Plan",
      },
      {
        slug: "prompt-input",
        name: "PromptInput",
        description: "Composer with attachments, tools, speech, and submit/stop.",
        importName: "PromptInput",
      },
      {
        slug: "queue",
        name: "Queue",
        description: "Pending messages and todos waiting to run.",
        importName: "Queue",
        rsc: true,
      },
      {
        slug: "reasoning",
        name: "Reasoning",
        description: "Collapsible thinking block that follows streaming.",
        importName: "Reasoning",
      },
      {
        slug: "response",
        name: "Response",
        description: "Streaming-friendly host for assistant markdown.",
        importName: "Response",
        rsc: true,
      },
      {
        slug: "sources",
        name: "Sources",
        description: "Expandable list of sources the model used.",
        importName: "Sources",
        rsc: true,
      },
      {
        slug: "suggestion",
        name: "Suggestions",
        description: "Horizontal row of prompt suggestion chips.",
        importName: "Suggestions",
        rsc: true,
      },
      {
        slug: "task",
        name: "Task",
        description: "Collapsible checklist of agent work.",
        importName: "Task",
        rsc: true,
      },
      {
        slug: "text-shimmer",
        name: "TextShimmer",
        description: "Shimmering placeholder text while a token stream starts.",
        importName: "TextShimmer",
      },
      {
        slug: "tool",
        name: "Tool",
        description: "Collapsible tool-call panel with input, output, and status.",
        importName: "Tool",
        rsc: true,
      },
      {
        slug: "web-preview",
        name: "WebPreview",
        description: "Sandboxed iframe preview with URL chrome and a console.",
        importName: "WebPreview",
      },
    ],
  },
  {
