  ...
  button: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "string",
          required: false,
          description: "Native type of the underlying element.",
        },
        {
          name: "disabled",
          type: "boolean",
      ...
      props: [
        {
          ...
          required: false,
          description: "Whether one or many items can be pressed.",
        },
        {
          name: "value",
          type: "string",
        ...
        },
        {
          ...
          type: '"ltr" | "rtl"',
          required: false,
          description: "Reading direction. Inherits from the document when omitted.",
        },
        {
          name: "loop",
          type: "boolean",
          required: false,
          description: "When true, keyboard navigation wraps around the ends.",
        },
      ],
    },
    {
      ...
      props: [
        {
          ...
          required: false,
          description: "How the list is positioned relative to the trigger.",
        },
        {
          name: "side",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "string",
          required: false,
          description: "Text used for typeahead. Defaults to the item's text.",
        },
        {
          name: "asChild",
          type: "boolean",
      ...
      props: [
        {
          ...
          type: "number[]",
          required: false,
          description: "Controlled thumbs. Pair with `onValueChange`.",
        },
        {
          name: "defaultValue",
          type: "number[]",
          required: false,
          description: "Uncontrolled initial thumbs.",
        },
        {
          name: "onValueChange",
        ...
        },
        {
          ...
          type: "(value: number[]) => void",
          required: false,
          description: "Called when a thumb is released.",
        },
        {
          name: "min",
          type: "number",
      ...
      props: [
        {
          ...
          type: "string",
          required: false,
          description: "Field path in the form values.",
        },
        {
          name: "control",
          type: "Control<TFieldValues>",
          required: false,
          description: "RHF control instance.",
        },
        {
          name: "render",
          type: "(props) => ReactNode",
          required: false,
          description: "Render-prop for the bound control.",
        },
      ],
    },
    {
      ...
      props: [
        {
          ...
          type: "number",
          required: false,
          description: "Delay before showing the fallback.",
        },
        {
          name: "asChild",
          type: "boolean",
  ...
  separator: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "boolean",
          required: false,
          description: "When true, hidden from the accessibility tree.",
          default: "true",
        },
        {
          name: "asChild",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "boolean",
          required: false,
          description: "Keep the node mounted when closed, for exit animation.",
        },
        {
          name: "asChild",
          type: "boolean",
      ...
      props: [
        {
          ...
          type: "number | null",
          required: false,
          description: "Current progress. `null` for indeterminate.",
        },
        {
          name: "max",
          type: "number",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "boolean",
          required: false,
          description: "When true, interaction outside the surface is blocked.",
        },
      ],
    },
    {
      ...
      props: [
        {
          ...
          type: "number",
          required: false,
          description: "Default open delay for nested tooltips.",
        },
        {
          name: "skipDelayDuration",
          type: "number",
          required: false,
          description: "Grace period when moving between tooltips.",
        },
        {
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "string",
          required: false,
          description: "Accessible name of the command list.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "string",
          required: false,
          description: "Seed value for the prompt field.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          required: false,
          description: "Lines cycled before the curve exits. Product lines by default.",
        },
        {
          name: "firstDelayMs",
          type: "number",
          required: false,
          description: "Hold after the first line has revealed, in ms.",
        ...
        },
        {
          ...
          type: "number",
          required: false,
          description: "Hold after each following line has revealed, in ms.",
        ...
        },
        {
          ...
          type: "number",
          required: false,
          description: "Extra hold on the last beat before `onComplete`, in ms.",
          default: "LAST_HOLD_MS",
        },
        {
          name: "end",
          type: "ReactNode",
          required: false,
          description: "Optional last beat — typically a brand mark — after the copy.",
        },
        {
          name: "onComplete",
          type: "() => void",
          required: false,
          description: "Fired after the last beat has been held. Unmount inside `AnimatePresence`.",
        },
        {
          name: "labels",
