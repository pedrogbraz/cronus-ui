 ...
 * adapts to the active mode: the `--cronus-syntax-*` vars (defined in globals.css)
  ...
  styles: [
    {
      ...
      style: { color: "var(--cronus-fg-tertiary)", fontStyle: "italic" },
    },
    { types: ["punctuation"], style: { color: "var(--cronus-fg-tertiary)" } },
    {
      types: ["tag", "operator", "keyword", "boolean", "selector"],
      style: { color: "var(--cronus-syntax-keyword)" },
    },
    {
      types: ["function", "class-name", "maybe-class-name"],
      style: { color: "var(--cronus-syntax-fn)" },
    },
    {
      types: ["string", "char", "attr-value", "inserted"],
      style: { color: "var(--cronus-syntax-string)" },
    },
    { types: ["attr-name", "property"], style: { color: "var(--cronus-syntax-attr)" } },
    { types: ["number", "constant", "symbol"], style: { color: "var(--cronus-syntax-number)" } },
    { types: ["script", "plain"], style: { color: "var(--cronus-fg-secondary)" } },
  ],
};
