...
export const metadata: Metadata = {
  title: "Cronus UI compared",
  description:
    "How Cronus UI sits next to shadcn/ui, HeroUI, and Aceternity: distribution, live theming, product generation, source ownership, AI, a11y gates, and the registry protocol.",
};

const rows = [
  {
    dimension: "Distribution",
    cronus: "npm package (@cronus-ui/ui) and copy-in via the CLI",
    shadcn: "Copy-in",
  ...
  },
  {
    ...
    cronus: "CLI copy-in + 3-way upgrade, incl. composed pages",
    shadcn: "Copy-in",
  ...
  },
  {
    ...
    cronus: "axe on catalog routes, contrast across 10 theme × mode combos, mechanical contract",
  ...
  },
  {
    ...
    cronus: "Speaks the shadcn spec at /r/*",
    shadcn: "Is the spec",
    heroui: "Separate",
  ...
  return (
    <div className="py-10">
      <DocsHeader
        ...
        title="Cronus UI compared"
        description="Cronus UI next to shadcn/ui, HeroUI, and Aceternity. It speaks the shadcn registry spec — it is not a fork. The layer above is the product: live theming, compose, a mechanical contract, and npm plus copy-in."
      >
      ...
      >
        <div className="overflow-x-auto rounded-xl border border-border">
          <table className="w-full min-w-[56rem] border-collapse text-left text-sm">
            <caption className="border-b border-border px-4 py-3 text-left text-sm text-fg-secondary">
              Cronus UI, shadcn/ui, HeroUI, and Aceternity compared on distribution, theming,
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.dimension} className="border-b border-border last:border-b-0">
                  ...
                  <td className="px-4 py-3 align-top text-fg">{row.cronus}</td>
        ...
        <p className="mt-4 text-sm leading-6 text-fg-secondary">
          ...
          <InlineCode>/r/registry.json</InlineCode>, so a shadcn-compatible CLI can install Cronus
