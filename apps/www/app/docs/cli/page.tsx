  ...
  return (
    <div className="py-10">
      ...
      <DocsSection
        ...
        description="compose generates pages and chrome from a bundled template (saas, store, landing, landing-*) or --manifest. -y with no name composes saas. Each page is imports of installed blocks plus a main landmark that stacks them."
      >
