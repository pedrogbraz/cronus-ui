...
test.describe("visual parity", () => {
  ...
  test("tilt-card default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "tilt-card", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "tilt-card-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("star-border default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "star-border", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "star-border-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("glass-card default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "glass-card", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "glass-card-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("terminal default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "terminal", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "terminal-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("video-player default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "video-player", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "video-player-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("text-effect default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "text-effect", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "text-effect-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("spotlight-card default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "spotlight-card", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "spotlight-card-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("animated-list default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "animated-list", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "animated-list-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("toast default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "toast", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "toast-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("carousel default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "carousel", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "carousel-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("code-block default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "code-block", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "code-block-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("description-list default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "description-list", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "description-list-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("kanban default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "kanban", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "kanban-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("json-viewer default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "json-viewer", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "json-viewer-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("animated-number default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "animated-number", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "animated-number-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("marquee default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "marquee", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "marquee-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("gradient-text default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "gradient-text", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "gradient-text-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("shiny-text default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "shiny-text", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "shiny-text-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });
  ...
  test("logo-carousel default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "logo-carousel", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "logo-carousel-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("dynamic-island default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "dynamic-island", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "dynamic-island-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("image-zoom default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "image-zoom", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "image-zoom-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("aurora-background default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "aurora-background", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "aurora-background-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("border-beam default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "border-beam", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "border-beam-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("confetti default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "confetti", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "confetti-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("composed-chart default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "composed-chart", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "composed-chart-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("heatmap-chart default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "heatmap-chart", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "heatmap-chart-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("chart default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "chart", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "chart-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("click-spark default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "click-spark", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "click-spark-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("glare-hover default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "glare-hover", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "glare-hover-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("magnetic default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "magnetic", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "magnetic-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("dot-pattern default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "dot-pattern", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "dot-pattern-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("flickering-grid default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "flickering-grid", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "flickering-grid-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("grid-pattern default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "grid-pattern", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "grid-pattern-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("highlighter default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "highlighter", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "highlighter-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("scramble-text default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "scramble-text", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "scramble-text-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });

  test("spinning-text default aurora/dark", async ({ page }) => {
    const frame = await openAudit(page, "spinning-text", "default", "aurora", "dark");
    await expect(frame.locator("[data-audit-canvas]")).toHaveScreenshot(
      "spinning-text-default-aurora-dark.png",
      SCREENSHOT_OPTIONS,
    );
  });
});
